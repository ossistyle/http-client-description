 ...
 */
class AbstractService implements ServiceInterface #extends \GuzzleHttp\Command\Guzzle\GuzzleClient
{
    ...
    ClientInterface $httpClient, Description $description, $config = []
    )
    {
        $this->httpClient = $httpClient;
        $this->description = $description;
        #parent::__construct($httpClient,$description, $config);
    }
...
//            );
            ...
            throw $e($msg, $this, $command, null, null, $e);
        }
    }
