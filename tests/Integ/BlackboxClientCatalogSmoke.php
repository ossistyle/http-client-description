...
class BlackboxClientCatalogSmokeTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testPostCatalogEmptyName()
    {
        $client = $this->createClient();
     ...
     * @return array
     */
    public function testPostCatalogNameTooLong()
    {
        $client = $this->createClient();
        $response = $client->postCatalog(
            [
     ...
     * @return array
     */
    public function testPostCatalogNoForeignId()
    {
        $client = $this->createClient();
        $response = $client->postCatalog(
            [
     ...
     * @return array
     */
    public function testPostCatalogChildCatalogHasIsRootLevelTrue()
    {
        $client = $this->createClient();
        $response = $client->postCatalog(
            [
